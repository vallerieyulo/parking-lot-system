...
public class ParkingLot {
    ...
    public ParkingLot(String parkingLotId, int nfloors, int noOfSlotsPerFlr) {
        ...
        System.out.println(parkingLotId + ", " + nfloors + ", " + noOfSlotsPerFlr);
    ...
    public void unPark(String ticketId) {
        ...
        for (int i=0;i < slots.size(); i++ ){
            for (int j=0; j < slots.get(i).size()l j++){
    ...
    // check if vehicle is null and if the type of slot matches with the type
    // requested
